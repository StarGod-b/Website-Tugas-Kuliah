...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            $stmt = $conn->prepare("INSERT INTO mobil (brand, model, type, fuel_type, transmission, seats, price_per_day, status, image) 
                                   VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([$brand, $model, $type, $fuel_type, $transmission, $seats,$price_per_day, $status, $image]);
            $success = true;
...
<head>
    ...
    <title>Tambah Mobil Baru | RentalMobil.SG</title>
...
<body>
    ...
    <div class="container">
        <div class="page-title">
            ...
            <p>Isi formulir di bawah ini untuk menambahkan mobil baru ke dalam sistem</p>
        </div>
        
        <div class="form-container">
            <?php if ($success): ?>
                <div class="alert alert-success">
                    <i class="fas fa-check-circle"></i> Mobil berhasil ditambahkan!
                    <a href="mobil.php" class="btn-edit" style="margin-left: auto;">Lihat Daftar Mobil</a>
                </div>
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="seats" name="seats" min="2" max="10" value="5" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="price_per_day" name="price_per_day" min="100000" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="image" name="image" placeholder="https://example.com/car.jpg" required>
                </div>
